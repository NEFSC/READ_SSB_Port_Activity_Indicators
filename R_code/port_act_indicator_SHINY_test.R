...
#write this as a csv so I can create 

#subset just variables we want available on shiny app
shiny_dat <-NE_normalized[c("year","place_id", "STATE_ABB",
                  "port_ind_score","port_work_score","port_volume_score","port_actors_score")]
